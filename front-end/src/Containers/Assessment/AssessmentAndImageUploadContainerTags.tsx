...
interface AssessmentAndImageUploadContainerTagsProps {
  errors: any;
  setValue: any;
  register: any;
  Controller: any;
...
const AssessmentAndImageUploadContainerTags: FC<AssessmentAndImageUploadContainerTagsProps> =
...
export default AssessmentAndImageUploadContainerTags;
